...
class Achievements {
  ...
  static const List<Achievement> all = [
    Achievement(
      ...
      emoji: '🌅',
      assetPath: 'assets/achievements/early_bird.tgs',
      xpReward: 25,
    ...
    Achievement(
      ...
      emoji: '🧠',
      assetPath: 'assets/achievements/deep_work_master.tgs',
      xpReward: 50,
    ...
    Achievement(
      ...
      emoji: '🔥',
      assetPath: 'assets/achievements/streak_7.tgs',
      xpReward: 100,
    ...
    Achievement(
      ...
      emoji: '⚡',
      assetPath: 'assets/achievements/streak_30.tgs',
      xpReward: 500,
      tier: AchievementTier.gold,
      category: AchievementCategory.streak,
      targetValue: 30,
    ...
    Achievement(
      ...
      emoji: '💯',
      assetPath: 'assets/achievements/streak_100.tgs',
      xpReward: 200,
      tier: AchievementTier.silver,
    ...
    Achievement(
      ...
      emoji: '✨',
      assetPath: 'assets/achievements/planner.tgs',
      xpReward: 150,
      tier: AchievementTier.gold,
    ...
    Achievement(
      ...
      emoji: '⚡',
      assetPath: 'assets/achievements/speed_demon.tgs',
      xpReward: 75,
      tier: AchievementTier.silver,
